...
function refreshCookieOptions() {
  ...
  if (!secure && process.env.ALLOW_SAMESITE_NONE_IN_DEV !== "true") {
    sameSite = "lax";
    console.warn(
      "refreshCookieOptions: running without TLS and SameSite=None would be rejected by browsers. Using SameSite='lax' in dev. To allow None in dev, set ALLOW_SAMESITE_NONE_IN_DEV=true and run HTTPS."
    );
  }
